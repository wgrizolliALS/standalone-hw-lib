...
def _colorStr(s: str, color: str = "", bold: bool = False) -> str:
    ...
    if FORCE_COLOR_OFF or color not in color_codes:
        return s
...
def print_verbose(msg: str, verbose: bool = True, timestamp: bool = False, color: str = "", bold: bool = False):
