...
def scan_for_labjacks():
      """
      Helper function to perform a scan and print the results.
      """
...
def get_channels_res(handle, num_channels=[0]):
    ...
    if device_type == 8:
        res_lookup = {0: "Default", 1: "Sinc1", 2: "Sinc1x4", 3: "Sinc1x16", 4: "Sinc1x64", 5: "Sinc4"}
    else:
        res_lookup = {
            0: "Default",
            1: "16-bit", 2: "17-bit", 3: "18-bit", 4: "19-bit",
            5: "20-bit", 6: "21-bit", 7: "22-bit", 8: "23-bit", 9: "24-bit"
        }
...
def acquire_dataT8(handle, num_samples=1000, sample_rate=1000, channels=None,
                 timeout_sec=5.0, resolution_idx=0
                 ):
    ...
    try:
        ...
        print(f"**** Starting stream with num_samples={num_samples}, sample_rate={sample_rate}, channels={channels} ****")
